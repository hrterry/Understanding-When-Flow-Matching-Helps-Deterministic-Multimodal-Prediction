...
def set_random_seed(seed, deterministic=False):
    """
    translated Python / NumPy / PyTorch translated。
    deterministic=True translated cudnn translated（translated，translated）。
    translated deterministic=False，translated「translated deterministic」translated，translated --deterministic。
    """
    random.seed(seed)
    np.random.seed(seed)
